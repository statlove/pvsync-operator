...
import (
	...
	pvcontroller "github.com/statlove/pvsync-operator/internal/controller" //ms: adding
        genericmanager "github.com/karmada-io/karmada/pkg/util/fedinformer/genericmanager" //ms: adding
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "89738fcc.dcn.karmada.io",
	...
	if err = (&controller.PVSyncController{
		...
		ClusterCacheSyncTimeout: metav1.Duration{Duration: 30 * time.Second}, //ms: adding
		WorkerNumber:            2, //ms: adding
		//Scheme: mgr.GetScheme(), ms: delete
